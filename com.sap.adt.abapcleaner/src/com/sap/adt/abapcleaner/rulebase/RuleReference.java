...
public class RuleReference {
	...
	public static String sourceName(RuleSource source) {
		...
		case VATTENFALL_SPECIFIC:
			return "Vattenfall spesific styleguide";
		case ABAP_CLEANER:
	...
	public final String getLink() {
		return hasLink() ? (subLink.startsWith("https://") ? subLink : baseLink(source) + subLink) : "";
	}

	public final boolean hasLink() {
		return !StringUtil.isNullOrEmpty(subLink);
	}
