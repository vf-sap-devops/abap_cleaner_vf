...
public class AlignDeclarationsRule extends AlignDeclarationSectionRuleBase {
   ...
   private final String[] structureAlignStyleTexts = new String[] { "align outer structure with inner", "align outer structure independently (like Pretty Printer)", "align each section independently" };
	...
	final ConfigEnumValue<AlignDeclarationsAction> configAlignChainAction = new ConfigEnumValue<AlignDeclarationsAction>(this, "AlignChainAction", "Action for chains:", alignChainActionTexts, AlignDeclarationsAction.values(), AlignDeclarationsAction.ALIGN_NAME_TYPE_LENGTH_ETC, AlignDeclarationsAction.ALIGN_NAME_TYPE_LENGTH_ETC, LocalDate.of(2023, 6, 10) ); 
	final ConfigEnumValue<AlignDeclarationsAction> configAlignNonChainsAction = new ConfigEnumValue<AlignDeclarationsAction>(this, "AlignNonChainsAction", "Action for consecutive non-chains:", alignNonChainsActionTexts, AlignDeclarationsAction.values(), AlignDeclarationsAction.ALIGN_NAME_TYPE_LENGTH_ETC, AlignDeclarationsAction.ALIGN_NAME_TYPE_LENGTH_ETC, LocalDate.of(2023, 6, 10) ); 
