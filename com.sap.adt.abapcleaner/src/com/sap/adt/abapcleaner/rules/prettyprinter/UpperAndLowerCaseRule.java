...
public class UpperAndLowerCaseRule extends RuleForCommands {
   ...
   public String getExample() {
	...
	final ConfigEnumValue<DeriveCaseMethod> configDeriveCaseMethod = new ConfigEnumValue<DeriveCaseMethod>(this, "DeriveCaseMethod", "Auto-determine upper/lower case", new String[] { "do not auto-determine", "derive from first class definition / method implementation statement", "derive from majority of tokens" }, DeriveCaseMethod.values(), DeriveCaseMethod.NONE, DeriveCaseMethod.NONE, LocalDate.of(2022, 6, 24));
	final ConfigEnumValue<CaseStyle> configDefinitionKeywordStyle = new ConfigEnumValue<CaseStyle>(this, "DefinitionKeywordStyle", "Keywords in CLASS ... DEFINITION section", selection, CaseStyle.values(), CaseStyle.UPPER_CASE, CaseStyle.UPPER_CASE, LocalDate.of(2021, 8, 15));
	final ConfigEnumValue<CaseStyle> configDefinitionIdentifierStyle = new ConfigEnumValue<CaseStyle>(this, "DefinitionIdentifierStyle", "Identifiers in CLASS ... DEFINITION section", selection, CaseStyle.values(), CaseStyle.LOWER_CASE, CaseStyle.LOWER_CASE, LocalDate.of(2021, 8, 15));
	final ConfigEnumValue<CaseStyle> configImplementationKeywordStyle = new ConfigEnumValue<CaseStyle>(this, "ImplementationKeywordStyle", "Keywords in all other places", selection, CaseStyle.values(), CaseStyle.UPPER_CASE, CaseStyle.UPPER_CASE, LocalDate.of(2021, 8, 15));
	final ConfigEnumValue<CaseStyle> configImplementationIdentifierStyle = new ConfigEnumValue<CaseStyle>(this, "ImplementationIdentifierStyle", "Identifiers in all other places", selection, CaseStyle.values(), CaseStyle.LOWER_CASE, CaseStyle.LOWER_CASE, LocalDate.of(2021, 8, 15));
	final ConfigEnumValue<CaseStyle> configPragmaStyle = new ConfigEnumValue<CaseStyle>(this, "PragmaStyle", "Pragmas", selection, CaseStyle.values(), CaseStyle.UPPER_CASE, CaseStyle.UNCHANGED, LocalDate.of(2023, 3, 18));
	final ConfigEnumValue<CaseStyle> configPragmaParameterStyle = new ConfigEnumValue<CaseStyle>(this, "PragmaParameterStyle", "Pragma parameters", selection, CaseStyle.values(), CaseStyle.UPPER_CASE, CaseStyle.UNCHANGED, LocalDate.of(2023, 3, 18));
